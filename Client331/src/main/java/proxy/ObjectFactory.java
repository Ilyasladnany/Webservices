...
public class ObjectFactory {
    ...
    private static final QName _Name_QNAME = new QName("http://ws/", "name");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "name")
    public JAXBElement<Compte> createName(Compte value) {
        return new JAXBElement<>(_Name_QNAME, Compte.class, null, value);
    }
